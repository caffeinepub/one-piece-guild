...
export class Backend implements backendInterface {
    ...
    async getTournaments(): Promise<Array<TournamentEntry>> {
        if (this.processError) {
            try {
    ...
    async postAnnouncement(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async registerPlayer(arg0: PlayerRegistration): Promise<void> {
        if (this.processError) {
            try {
    ...
    async registerTournament(arg0: TournamentEntry): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.registerTournament(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async sendComplaint(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.sendComplaint(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
